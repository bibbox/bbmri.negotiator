...
public class DirectoryCatalogue implements Serializable {

	private static final long serialVersionUID = -1813397634;
	...
	public DirectoryCatalogue(DirectoryCatalogue value) {
		this.id = value.id;
