...
public class BiobankRecord extends UpdatableRecordImpl<BiobankRecord> implements Record5<Integer, String, String, Integer, String> {

	private static final long serialVersionUID = -1649893491;
	...
	/**
	 * Setter for <code>public.biobank.directory_catalogue_id</code>. The Directory Catalogue this biobank belongs to
	 */
	public void setDirectoryCatalogueId(Integer value) {
		setValue(3, value);
	}

	/**
	 * Getter for <code>public.biobank.directory_catalogue_id</code>. The Directory Catalogue this biobank belongs to
	 */
	public Integer getDirectoryCatalogueId() {
	...
	public Field<Integer> field4() {
		return Biobank.BIOBANK.DIRECTORY_CATALOGUE_ID;
	}
	...
	public Integer value4() {
		return getDirectoryCatalogueId();
	}
	 ...
	 */
	@Override
	public BiobankRecord value4(Integer value) {
		setDirectoryCatalogueId(value);
		return this;
	}
	 ...
	 */
	@Override
	public BiobankRecord value5(String value) {
	 ...
	 */
	@Override
	public BiobankRecord values(Integer value1, String value2, String value3, Integer value4, String value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public BiobankRecord(Integer id, String name, String description, Integer directoryCatalogueId, String directoryId) {
		super(Biobank.BIOBANK);

		setValue(0, id);
		setValue(1, name);
		setValue(2, description);
		setValue(3, directoryCatalogueId);
