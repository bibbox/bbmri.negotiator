INSERT INTO directory_catalogue(id, name, url, rest_url, username, password, api_username, api_password, resource_biobanks, resource_collections, description, sync_active) VALUES (1, 'Dummy BBMRI-ERIC', 'https://does-not-exist.com', 'https://does-not-exist.com', 'admin', 'admin', 'admin', 'admin', 'eu_bbmri_eric_biobanks', 'eu_bbmri_eric_collections', 'Dummy BBMRI-ERIC Catalouge', false);
INSERT INTO directory_catalogue(id, name, url, rest_url, username, password, api_username, api_password, resource_biobanks, resource_collections, description, sync_active) VALUES (2, 'Dummy RD-Connect', 'https://does-not-exist.org', 'https://does-not-exist.org', 'admin', 'admin', 'admin', 'admin', 'eu_bbmri_eric_biobanks', 'eu_bbmri_eric_collections', 'Dummy RD-Connect Catalouge', false);
INSERT INTO directory_catalogue(id, name, url, rest_url, username, password, api_username, api_password, resource_biobanks, resource_collections, description, sync_active) VALUES (3, 'BBMRI-ERIC', 'http://d1.ref.development.bibbox.org', 'http://d1.ref.development.bibbox.org', 'admin', 'admin', 'admin', 'admin', 'eu_bbmri_eric_biobanks', 'eu_bbmri_eric_collections', 'BBMRI-ERIC Catalouge', true);
ALTER SEQUENCE directory_catalogue_id_seq RESTART WITH 4;

INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (1, '1', 'Biobank Hamburg', 1, 'The biobank for sample from the DKTK in Hamburg managed by the HU');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (2, '2', 'Biobank Berlin', 1, 'The biobank for tissue samples in Berlin managed by the Charite');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (3, '3', 'Biobank München', 1, 'The biobank for blood samples in München managed by the TU München');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (4, '4', 'Biobank Münster', 1, 'The C* biobank in Münstermanaged by the UKM Pathology');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (5, '5', 'Biobank Mainz', 1, 'The C40-49 biobank in Mainz managed by the JGU MedInfo');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (6, '6', 'Biobank Heidelberg', 1, 'The C95 biobank in Heidelberg managed by Zeis');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (7, '7', 'Usertest Biobank 1', 1, 'A biobank for testing only');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (8, '8', 'Usertest Biobank 2', 1, 'A biobank for testing only');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (9, '9', 'Usertest Biobank 3', 1, 'A biobank for testing only');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (10, '10', 'Usertest Biobank 4', 1, 'A biobank for testing only');
INSERT INTO biobank(id, directory_id, name, directory_catalogue_id, description) VALUES (11, '11', 'Usertest Biobank 5', 1, 'A biobank for testing only');
ALTER SEQUENCE biobank_id_seq RESTART WITH 12;

INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (1, '1', 'Hamburg Blood Samples', 1, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (2, '2', 'Berlin Blood Samples', 2, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (3, '3', 'München Blood Samples', 3, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (4, '4', 'Münster Blood Samples', 4, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (5, '5', 'Mainz Blood Samples', 5, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (6, '6', 'Heidelberg Blood Samples', 6, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (7, '7', 'Usertest Collection 1', 7, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (8, '8', 'Usertest Collection 2', 7, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (9, '9', 'Usertest Collection 3', 7, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (10, '10', 'Usertest Collection 4', 8, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (11, '11', 'Usertest Collection 5', 8, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (12, '12', 'Usertest Collection 6', 8, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (13, '13', 'Usertest Collection 7', 9, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (14, '14', 'Usertest Collection 8', 9, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (15, '15', 'Usertest Collection 9', 9, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (16, '16', 'Usertest Collection 10', 10, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (17, '17', 'Usertest Collection 11', 10, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (18, '18', 'Usertest Collection 12', 10, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (19, '19', 'Usertest Collection 13', 11, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (20, '20', 'Usertest Collection 14', 11, 1);
INSERT INTO collection(id, directory_id, name, biobank_id, directory_catalogue_id) VALUES (21, '21', 'Usertest Collection 15', 11, 1);
...
INSERT INTO person(id, auth_subject, auth_name, auth_email, person_image, is_admin) VALUES (20, 'admin001','BBMRI ADMIN', 'admin@negotiator', NULL, TRUE);
